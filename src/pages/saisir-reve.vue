...
const docreatedream = async () => {
    try {
        const dream = {
            ...
            "users": pb.value.authStore.model.id,
    ...
    <div class="h-min-screen">
        ...
        <div class="relative pt-28 mt-6 ">
            ...
            <div class="mt-5 px-6">
                ...
                <div v-if="recit">
                    <input class="h5 placeholder:text-gray-50 border-none bg-violet-900 mb-1" v-model="Titre"
                        type="text" name="Titre" id="Titre" autocomplete="none" placeholder="Ajoute un titre" />
                    <input class=" placeholder:text-gray-50 border-none bg-violet-900 pb-[35dvh]" v-model="Description"
                        type="text" name="Description" id="Description" autocomplete="none"
